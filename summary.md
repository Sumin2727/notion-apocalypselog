...
jang-suin,장수인,F,29,회사원,리더/탐색,"침착, 차분, 이성적","약점 간파, 별의 시야","장창, 가죽갑옷",정상,,40,60,50,55,55,65,60,60,50,"성좌P=2"

lee-dohyun,이도현,M,26,의대생/남성대표,의술·보호,"성실, 책임감, 상냥함",잠재,"개조식 칼, 방패",정상,72,55,55,55,55,50,55,50,60,50,""
park-jiyeon,박지연,F,27,간호사,의료·석궁,"활발, 담대, 직설적, 장난스러움",잠재,"석궁",정상,68,45,60,55,60,55,60,55,70,50,"석궁 특화"
kim-sangwoo,김상우,M,34,목수,건축·수리,"실용적, 유머러스, 장인기질",제작 강화,"철제 방망이, 방패","경미한 부상, 회복중",55,55,65,60,50,45,55,55,65,45,""
jung-taesik,정태식,M,42,정비사,기계·발전기,"신중, 분석적, 꼼꼼",기계 이해,"없음","부상(다리)",50,65,70,60,50,40,55,60,60,40,""
...
- 식수 : 매일 보충, 안정적
- 연료(발전기) : 119.45L (7일치) - 축전지로 에너지 효율↑
- 차량 : 소형 SUV(연료 42L)
